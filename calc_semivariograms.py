...
def calc_semi_para(ifgix):
        ...
        if sill == sill:
            if os.path.exists(os.path.join(outdir, 'semivariograms', 'semivarigram{}X.png'.format(ifgd))):
                os.remove(os.path.join(outdir, 'semivariograms', 'semivarigram{}X.png'.format(ifgd)))
            plt.savefig(os.path.join(outdir, 'semivariograms', 'semivarigram{}X.png'.format(ifgd)))
        else:
            if os.path.exists(os.path.join(outdir, 'semivariograms', 'semivarigram{}.png'.format(ifgd))):
                os.remove(os.path.join(outdir, 'semivariograms', 'semivarigram{}.png'.format(ifgd)))
